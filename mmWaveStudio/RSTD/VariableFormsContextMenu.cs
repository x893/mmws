...
namespace RSTD
{
	...
	internal class VariableFormsContextMenu : VariableContextMenu
	{

		public VariableFormsContextMenu(PassedVarData dataPassed, frmSubSet sub_set) : base(dataPassed, sub_set)
		{
			this.iInitMembers(dataPassed, RstdConstants.CONTEXT_MENU_ORIGIN.SUB_SET);
		}


		public VariableFormsContextMenu(PassedVarData dataPassed, RstdConstants.CONTEXT_MENU_ORIGIN var_menu_display) : base(dataPassed, var_menu_display)
		{
